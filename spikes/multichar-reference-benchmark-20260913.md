...
資料更新：2026-09-13T16:04:56.662069+00:00。**持續實驗中，非最終結論。**
...
|---|---:|---:|---:|---:|---:|---:|
| Codex built-in | 60 | 6 | 6 | 0 | 0 | 6 |
| Qwen Edit 2511 | 60 | 4 | 4 | 0 | 24 | 4 |
...
| live-01-wave-r1 | pending | [succeeded](assets/multichar-reference-20260913/runs/qwen/live-01-wave-r1/result.json) | pending |
...
| live-03-wave-r1 | [succeeded](assets/multichar-reference-20260913/runs/codex/live-03-wave-r1/result.json) | pending | pending |
...
| Codex | Qwen | H3首幀 |
|---|---|---|
| 未產出／待執行 | ![qwen](assets/multichar-reference-20260913/runs/qwen/live-01-wave-r1/output.png) | 未產出／待執行 |
...
| Codex | Qwen | H3首幀 |
|---|---|---|
| ![codex](assets/multichar-reference-20260913/runs/codex/live-03-wave-r1/output.png) | 未產出／待執行 | 未產出／待執行 |
