...
資料更新：2026-09-13T16:54:42.316567+00:00。**持續實驗中，非最終結論。**
...
|---|---:|---:|---:|---:|---:|---:|
| Codex built-in | 60 | 36 | 35 | 1 | 0 | 35 |
| Qwen Edit 2511 | 60 | 6 | 6 | 0 | 24 | 6 |
| H3 Ref2VA 5 frames | 60 | 8 | 8 | 0 | 0 | 8 |
...
| anime-05-wave-r1 | [succeeded](assets/multichar-reference-20260913/runs/codex/anime-05-wave-r1/result.json) | unsupported | pending |
...
| Codex | Qwen | H3首幀 |
|---|---|---|
| ![codex](assets/multichar-reference-20260913/runs/codex/anime-05-wave-r1/output.png) | 未產出／待執行 | 未產出／待執行 |
