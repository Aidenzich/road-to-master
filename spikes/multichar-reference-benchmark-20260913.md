...
資料更新：2026-09-13T20:18:41.452984+00:00。**持續實驗中，非最終結論。**
...
| Qwen Edit 2511 | 60 | 22 | 22 | 0 | 24 | 22 |
...
目前交集為 21 個場景。此表以成功且完成評估為條件，會排除失敗及不支援條件，存在完整案例選擇偏差；不是完整成功率或公平模型排名。尺寸、前處理、量化與seed可控性等差異仍存在。
...
| Qwen Edit 2511 | exact_count | 4/30 | 4 | 0 | 2 |
| Qwen Edit 2511 | appearance_preserved | 4/30 | 4 | 0 | 0 |
| Qwen Edit 2511 | reference_binding | 4/30 | 4 | 0 | 1 |
| Qwen Edit 2511 | action_obedience | 4/30 | 1 | 3 | 0 |
| Qwen Edit 2511 | hands_and_contacts | 4/30 | 3 | 1 | 3 |
