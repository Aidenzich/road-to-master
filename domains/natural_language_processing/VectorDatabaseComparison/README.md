...
- [BM25](../information_retrieval/BM25/) — hybrid search 的 sparse/keyword 那一路就是 BM25，本筆記對「hybrid = dense + BM25 融合」的定義即以此為基礎。
- [TF-IDF](../information_retrieval/TFIDF/) — 稀疏檢索的前身，理解 sparse-dense 融合的權重取捨時的背景。
