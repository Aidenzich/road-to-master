...
> **Version postscript (2026-07-26)**: This section and the Figure 4 attached above correspond to the arXiv version this note was written from, whose Head is 17.2 / 57.9 / 67.9 / 86.7 / 92.1. A **newer version of the paper has updated Figure 4 to values consistent with the table** (Head 18.9 / 48.3 / 61.3 / 83.4 / 90.5, matching the table's 48.3 / 83.4 / 90.5) — i.e., the authors have since fixed exactly the figure/table inconsistency flagged here, which **corroborates that the original figure was indeed wrong**. When citing absolute values, defer to the Figure 4 in the paper version you hold.
