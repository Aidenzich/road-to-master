...
> **版本後記（2026-07-26）**：本節與上方所附的 Figure 4 對應本筆記撰稿所依據的 arXiv 版本，其 Head 為 17.2 / 57.9 / 67.9 / 86.7 / 92.1。論文**較新的版本已把 Figure 4 更新為與表格一致的數值**（Head 18.9 / 48.3 / 61.3 / 83.4 / 90.5，恰好對上表格的 48.3 / 83.4 / 90.5）——也就是說作者事後修掉了本節指出的圖表不一致，反過來**佐證了原圖確有問題**。引用絕對數值時，請以你手上論文版本的 Figure 4 為準。
